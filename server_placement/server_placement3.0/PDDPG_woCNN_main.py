...
import envirment
import output
import control_group.PDDPG_woCNN
...
ddpg = control_group.PDDPG_woCNN.PDDPG(a_dim, s_dim)
...
for i_episode in range(MAX_EPISODES):
    ...
    for t in range(1, SLOTNUM):
        ...
        if i_episode%3==0 and t%100==0:
            reward_list = adapt_speed.Calculate_AdaptSpeed(env, a_last, i_episode, t, Date, SLOTNUM)
